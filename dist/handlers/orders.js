...
var ord = new orders_1.Order();
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, authorizationHeader, token, decodedToken, o, neword, err_1;
...
var addProductToOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, op, newprodtoord, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
            ...
            case 1:
                ...
                return [4 /*yield*/, ord.addProductToOrder(op)];
            case 2:
                newprodtoord = _a.sent();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, order1, prods1, oprods, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, ord.showOrder(Number(req.params.id))];
            case 2:
                order1 = _b.sent();
                return [4 /*yield*/, ord.showOrderProducts(Number(req.params.id))];
            case 3:
                prods1 = _b.sent();
                oprods = {

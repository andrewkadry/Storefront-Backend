...
var _a = process.env, BCRYPT_PASSWORD = _a.BCRYPT_PASSWORD, HASH_ROUND = _a.HASH_ROUND;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("error while connecting to users table ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("error while getting this user ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1["default"].hashSync(u.password + BCRYPT_PASSWORD, parseInt(HASH_ROUND));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("error while deleting this user ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
